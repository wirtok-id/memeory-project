...
abstract class $BookmarkCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String userId, String memeId, DateTime createdAt});
}
...
class _$BookmarkImpl implements _Bookmark {
  ...
  @override
  String toString() {
    return 'Bookmark(id: $id, userId: $userId, memeId: $memeId, createdAt: $createdAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, memeId, createdAt);
